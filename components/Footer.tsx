      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-2 gap-16 mb-20 items-center">
        <div>
          ...
          <motion.a 
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-block px-10 py-5 rounded-full bg-accent text-white font-display uppercase tracking-widest text-sm hover:bg-white hover:text-black transition-colors shadow-[0_0_20px_rgba(139,92,246,0.4)] hover:shadow-[0_0_30px_rgba(255,255,255,0.6)]"
          >
            Get in touch
          </motion.a>
        </div>
